...
public class Wind extends Hero implements Runnable {
    public boolean exit = false;
    Thread t;

    public Wind(int x, int y, boolean a, Icon i, int v) {
        super(75, 2, 4, x, y, a, i, v);
        exit = false;
    }
        ...
        while (!exit) {
            ...
            if (team == 1) {
                ...
                if (mainFrame.checkSyahchale(this)) {
                    ...
                    JOptionPane.showMessageDialog(mainFrame.c1.jb, "wind1 was removed from the game", "result of the battle", JOptionPane.INFORMATION_MESSAGE);
                    this.stop();
                }
                try {
                ...
                if (mainFrame.checkSyahchale(this)) {
                    this.jb.setVisible(false);
                    JOptionPane.showMessageDialog(mainFrame.c1.jb, "wind2 was removed from the game", "result of the battle", JOptionPane.INFORMATION_MESSAGE);
                    this.stop();
                }
                try {
